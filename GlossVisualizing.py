...
from PoseLooker import PoseLooker, get_glossDict, get_word_to_gloss_dict
import Levenshtein
    ...
    for gloss in glosses:
        ...
        if gloss not in all_dict[spoken_language][sing_language]:
            ...
            for word in all_dict[spoken_language][sing_language]:
                ...
                score = calculateDistance(gloss, word)
...
def computePoseGif(gloss_sentence, words_to_process_while_looking):
    ...
    with open("./assets/GeneratedPoses/" + title + ".pose", "rb") as f:
        p = Pose.read(f.read())
