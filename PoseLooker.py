...
poses_dir_path = "./assets/signsuisse"
csv_name = "index.csv"
missing_glosses = set()
...
def get_best_point_connection(pose1, pose2, kernel_size_percent=0.3, metric="euclidean"):
    ...
    #motivul pentru care ales last movements din primul cadrul si primele miscari din al doilea e ca sa compar
...
def PoseLooker(glosses, title):
    ...
    with open("./assets/GeneratedPoses/" + title + ".pose", "wb") as f:
        final_pose.write(f)
